...
export class ProductoService {
    private baseUrl = 'https://backend-minimarket-3swy.onrender.com/producto';
    ...
    public getStockBajo(): Observable<any> {
        return this.httpClient.get(`${this.baseUrl}/getstockbajo`);
    }
