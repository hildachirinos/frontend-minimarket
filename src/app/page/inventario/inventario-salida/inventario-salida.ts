...
export class InventarioSalida implements OnInit {
    ...
    public registrar(): void {
        ...
        if (this.productoSeleccionado && this.cantidadFb.value > this.productoSeleccionado.stockActual) {
            alert('No hay suficiente stock disponible. Stock actual: ' + this.productoSeleccionado.stockActual);
            return;
        }
        ...
        this.inventarioService.registrarSalida(formData).subscribe({
            next: (response: any) => {
